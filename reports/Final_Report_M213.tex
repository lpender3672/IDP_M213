...
The CAD drawings and render of the final robot can be seen in \Cref{fig:CAD}.

\begin{figure}[!h]
    \centering
    \includegraphics[width=0.8\textwidth]{assets/CAD_drawing_and_render.png}
    \caption{CAD drawing and render of the Robot}
    \label{fig:CAD}
\end{figure}
