...
\includegraphics[width=0.8\textwidth]{assets/Schematic.jpg}
...
\includegraphics[width=0.8\textwidth]{assets/Proto.jpg}
\includegraphics[width=0.8\textwidth]{assets/Board.jpg}
\subsection{OpenCV}
