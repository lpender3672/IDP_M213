...
\begin{itemize}
    \item the actual performance of line-following system in the competition (20 scores), the upper limit of scores can be lower than openCV system due to time-counting for picking up block.
